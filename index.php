      ...
      <section id="projects">
        <div class='container'>
            ...
            <div class="projects-copy">
              <div class="projects-window card-deck">
                <div class="card project-card text-center">
                  <img class="card-img-top" src="resources/images/bftales.png" alt="bftales image">
                  <!-- 256 x 180 -->
                  <div class="card-block">
                    <div class="card-text">
                      <h4 class="card-title">Best-Friend Tales</h4>
                      <p class="card-text">A social network for people looking to adopt rescue pets, and for pet owners to post and comment on discussion topics.</p>
                    </div>
                    <a href="http://www.bftales.com" class="btn btn-primary card-btn">Go to Site</a>
                  </div>
                  <div class="card-footer">
                    <p class="card-text"><small class="text-muted">Sinatra, Postgres, Sendgrid, Active-Record, Materialize</small></p>
                  </div>
                </div>

                <div class="card project-card text-center">
                    <img class="card-img-top" src="resources/images/game-on.png" alt="Card image cap">
                    <!-- 256 x 180 -->
                    <div class="card-block">
                      <div class="card-text">

                        <h4 class="card-title">Game-On</h4>
                        <p class="card-text">A sport team managment mobile app with in app team chat.</p>
                      </div>
                      <a href="https://github.com/ttalhouk/Game_On" class="btn btn-primary card-btn">Go to Repo</a>
                    </div>
                    <div class="card-footer">
                      <p class="card-text"><small class="text-muted">Rails-API, React-Native, Postgres, Firebase</small></p>
                    </div>
                  </div>

                <div class="card project-card text-center">
                  <img class="card-img-top" src="resources/images/bgs.png" alt="boardgame-social image">
                  <!-- 256 x 180 -->
                  <div class="card-block">
                    <div class="card-text">

                      <h4 class="card-title">Boardgame-Social</h4>
                      <p class="card-text">A social network for boardgame enthusiests to view collection and set up friendships and track traded games.</p>
                    </div>
                    <a href="https://boardgame-social.herokuapp.com/" class="btn btn-primary card-btn">Go to Site</a>
                  </div>
                  <div class="card-footer">
                    <p class="card-text"><small class="text-muted">Rails, Postgres, jQuery, Bootstrap</small></p>
                  </div>
                </div>
                ...
                <div class="card project-card text-center">
                  ...
                  <div class="card-block">
                    <div class="card-text">
                      ...
                      <p class="card-text">A Rails app as part of a lightning talk to show how to use data visualization techniques.</p>
                    </div>
                    <a href="https://exoplanet-analysis.herokuapp.com/" class="btn btn-primary card-btn">Go to Site</a>
                  </div>
                  <div class="card-footer">
